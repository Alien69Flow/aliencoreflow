...
const spaces = [
  ...
  },
  {
    ...
    icon: <Users className="h-10 w-10 text-alien-gold" />,
    link: '/clubs'
  },
  {
    id: 'conetworking',
...
const ExploreSpacesSection = () => {
  return (
    <section className="py-24 bg-alien-space-light/20 relative overflow-hidden">
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-4xl font-bold mb-4 text-alien-gold text-glow font-[Atomic Age]">
            Explore AlienFlow Spaces
          </h2>
