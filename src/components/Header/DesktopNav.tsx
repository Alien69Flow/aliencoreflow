    ...
    <NavigationMenu className="hidden md:block">
      <NavigationMenuList>
        ...
        <NavigationMenuItem>
          ...
          <NavigationMenuContent className="absolute top-full left-0 bg-alien-space-dark/95 backdrop-blur-lg border border-alien-gold/20 p-2 rounded-lg min-w-[220px] z-50">
        ...
        <NavigationMenuItem>
          ...
          <NavigationMenuContent className="absolute top-full left-0 bg-alien-space-dark/95 backdrop-blur-lg border border-alien-gold/20 p-2 rounded-lg w-[180px] z-50">
