      ...
      <NavigationMenu className="max-w-none">
        <NavigationMenuList className="space-x-1">
          ...
          <NavigationMenuItem>
            ...
            <NavigationMenuContent className="bg-alien-space-dark border border-alien-gold/20 p-4 rounded-md w-[320px] shadow-lg">
          ...
          <NavigationMenuItem>
            ...
            <NavigationMenuContent className="bg-alien-space-dark border border-alien-gold/20 p-2 rounded-md w-[220px] shadow-lg">
