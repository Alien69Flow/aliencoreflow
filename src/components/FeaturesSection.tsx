...
const FeaturesSection = () => {
  return (
    <section className="py-20 relative bg-alien-space-dark overflow-hidden">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            AlienFlowSpace offers cutting-edge technologies to support our interstellar ecosystem
          </p>
        </motion.div>
      ...
      <div className="absolute top-0 left-0 w-full h-20 bg-gradient-to-b from-alien-space to-transparent"></div>
