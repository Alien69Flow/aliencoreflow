  ...
  return <section className="py-20 relative overflow-hidden">
      <div className="container mx-auto px-4">
        ...
        once: true
          ...
          once: true
        }} className="text-xl max-w-5xl mx-auto text-gray-300 font-[Exo] leading-relaxed">Any Individual or Professional can Understand the Advantage of Digital Money · Impartial Money that does not discriminate, Decentralized Currencies, Stable without Volatility, As Well As Safe Reserves of Values. Access with Crypto, NFTs, Tokens to Order &amp; Generate All Types of Experiences, Products &amp; Services According to your Demands Instantly...</motion.p>
        </motion.div>
        ...
        once: true
          ...
          <p className="text-gray-300 mb-4 font-[Exo]">Aurum ₿iTCoin cryptoken serves as collateral and derivative of Bitcoin, providing stability and growth potential (Φπ) in the cosmic ecosystem.</p>
