          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex items-center p-4 bg-alien-space-dark/60 rounded-lg backdrop-blur-md hover:bg-alien-space-dark/80 transition-colors border border-alien-gold/20">
                  ...
                  <div>
                    ...
                    <a href="mailto:info@alienflow.space" className="text-gray-300 font-[Exo] hover:text-alien-green text-sm">info@alienflow.space</a>
                  </div>
                </div>
                ...
                <div className="flex items-center p-4 bg-alien-space-dark/60 rounded-lg backdrop-blur-md hover:bg-alien-space-dark/80 transition-colors border border-alien-gold/20">
                  ...
                  <div>
                    ...
                    <a href="https://discord.gg/alienflowspace" target="_blank" rel="noopener noreferrer" className="text-gray-300 font-[Exo] hover:text-alien-green text-sm">discord.gg/alienflowspace</a>
                  </div>
                </div>
                ...
                <div className="flex items-center p-4 bg-alien-space-dark/60 rounded-lg backdrop-blur-md hover:bg-alien-space-dark/80 transition-colors border border-alien-gold/20">
                  ...
                  <div>
                    ...
                    <a href="https://x.com/alien69flow" target="_blank" rel="noopener noreferrer" className="text-gray-300 font-[Exo] hover:text-alien-green text-sm">@alien69flow</a>
                  </div>
                </div>
                ...
                <div className="flex items-center p-4 bg-alien-space-dark/60 rounded-lg backdrop-blur-md hover:bg-alien-space-dark/80 transition-colors border border-alien-gold/20">
                  ...
                  <div>
                    ...
                    <a href="https://www.facebook.com/Alien69Flow" target="_blank" rel="noopener noreferrer" className="text-gray-300 font-[Exo] hover:text-alien-green text-sm">facebook.com/Alien69Flow</a>
                  </div>
                </div>
                ...
                <div className="flex items-center p-4 bg-alien-space-dark/60 rounded-lg backdrop-blur-md hover:bg-alien-space-dark/80 transition-colors border border-alien-gold/20">
                  ...
                  <div>
                    ...
                    <a href="https://www.instagram.com/alien69flow/" target="_blank" rel="noopener noreferrer" className="text-gray-300 font-[Exo] hover:text-alien-green text-sm">@alien69flow</a>
                  </div>
                </div>
                ...
                <div className="flex items-center p-4 bg-alien-space-dark/60 rounded-lg backdrop-blur-md hover:bg-alien-space-dark/80 transition-colors border border-alien-gold/20">
                  ...
                  <div>
                    ...
                    <a href="https://T.Me/AlienFlow" target="_blank" rel="noopener noreferrer" className="text-gray-300 font-[Exo] hover:text-alien-green text-sm">t.me/AlienFlow</a>
                  </div>
                </div>
                ...
                <div className="flex items-center p-4 bg-alien-space-dark/60 rounded-lg backdrop-blur-md hover:bg-alien-space-dark/80 transition-colors border border-alien-gold/20">
                  ...
                  <div>
                    ...
                    <a href="https://github.com/AlienFlowSpaceDAO" target="_blank" rel="noopener noreferrer" className="text-gray-300 font-[Exo] hover:text-alien-green text-sm">github.com/AlienFlowSpaceDAO</a>
                  </div>
                </div>
                ...
                <div className="flex items-center p-4 bg-alien-space-dark/60 rounded-lg backdrop-blur-md hover:bg-alien-space-dark/80 transition-colors border border-alien-gold/20">
                  ...
                  <div>
                    ...
                    <a href="https://linkedin.com/in/alienflow" target="_blank" rel="noopener noreferrer" className="text-gray-300 font-[Exo] hover:text-alien-green text-sm">linkedin.com/in/alienflow</a>
                  </div>
                </div>
              </div>
            </div>
            
            {/* Compact message form - takes 1 column */}
            <div className="bg-alien-space-dark/60 p-6 rounded-lg backdrop-blur-md border border-alien-gold/20">
              ...
              <form className="space-y-4">
                ...
                <Button className="w-full bg-alien-green hover:bg-alien-green-light text-alien-space-dark font-[Exo] text-sm">
